            ...
            <div
                ...
                <div>
                    <div class="flex justify-between">
                        <div class="flex">
                            <div><svg width="41" height="41" viewBox="0 0 41 41" fill="none"
                            ...
                            <div class="text-[24px] font-bold ml-[8px] flex justify-center items-center">มิเตอร์น้ำ</div>
                        </div>
                        <div class="flex border pl-[14px] pr-[14px]  rounded-[12px] cursor-pointer ">
                            ...
                            <div class="text-[14px] font-bold ml-[8px] flex justify-center items-center">กำหนดค่าน้ำ</div>
                        </div>
                    </div>
                    <div class="flex justify-between">
                        <div class="flex">
...
export default {
    components:{Water,Electricity,CommonFee },
    data() {
        return {
            tab: 1,
            popup_filter: false
