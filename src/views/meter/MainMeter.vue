            ...
            <div
                                ...
                                <vs-tooltip bottom shadow not-hover v-model="popup_filter">
                                    <div @click="popup_filter = true"
                                        ...
                                        <div class="flex justify-center items-center">
                                            <svg width="22" height="23" viewBox="0 0 22 23" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="mask0_3262_4178" style="mask-type:alpha"
                ...
                <div class="flex justify-end">
                    <div v-if="tab == 1" class="flex">
                        <div> <input class="h-[28px] w-[120px] rounded-[12px] border flex justify-start" id="upload" hidden
                            ...
                            <label for="upload">
                                <div
                                    ...
                                    <div class="text-white font-bold ml-[8px]   flex justify-center items-center">
                                        นำเข้ามิเตอร์น้ำผ่าน
                                        Excel
                                    </div>
                                </div>
                            </label>
                        </div>
                        <div> <label class="ml-[14px]">
                                <div
                                    class="h-[36px] pl-[8px] pr-[8px] bg-[#39B974] flex cursor-pointer  justify-center rounded-[12px] mt-[12px]">
                                    <div class="flex justify-center items-center">
                                        <svg width="22" height="23" viewBox="0 0 22 23" fill="none"
                                    ...
                                    <div class="text-white font-bold ml-[8px]   flex justify-center items-center"><a
                                            href="https://api.resguru.app/uploads/meter_Template_a0c087bcd6.xlsx"
                                            class="text-white " target="_blank" download> Download
                                            Excel Template </a>
                                    </div>
                                </div>
                            </label></div>
