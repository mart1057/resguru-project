  ...
  <div class="pl-[20px] pr-[20px] pt-[10px]">
    <div class="h-[100%] rounded-[12px] mt-[14px]">
      <div class="grid grid-cols-4 w-[100%] gap-2">
        <div
          class="h-[136px] rounded-[32px] flex justify-between items-center pl-[24px] pr-[24px] cursor-pointer"
          @click="(tab = 1), (filter.search = '')"
          :class="
            tab == 1 ? 'bg-[#2875E9] text-[white]' : 'bg-[white] text-[#003765]'
          "
        >
          <div>
            <svg
        ...
        <div
          ...
          :class="
            tab == 2 ? 'bg-[#F5D65E] text-[white]' : 'bg-[white] text-[#003765]'
          "
        >
          <div>
            <svg
        ...
        <div
          ...
          :class="
            tab == 3 ? 'bg-[#1DC56A] text-[white]' : 'bg-[white] text-[#003765]'
          "
        >
          <div>
            <svg
        ...
        <div
          ...
          :class="
            tab == 4 ? 'bg-[#5D5FEF] text-[white]' : 'bg-[white] text-[#003765]'
          "
        >
          <div>
            <template>
      ...
      >
        <div>
          <div class="flex justify-between">
            ...
            <div
              class="flex border pl-[14px] pr-[14px] rounded-[12px] cursor-pointer"
            ...
            >
              ...
              <div
                class="text-[14px] font-bold ml-[8px] flex justify-center items-center"
              >
                กำหนดค่า
              </div>
            </div>
              ...
              <div>
                <div class="flex justify-start items-center mt-[5px]">
                  <input
                    ...
                    @input="$refs.childComponentRef.filterData(filter.search)"
                    type="input"
...
export default {
  ...
  methods: {
    getFloorStorageKey() {
      return `mainMeterSelectedFloor_${this.$store.state.building}`;
    },
    ...
    selectFloor(floorData, index) {
      ...
      this.callChildFunction(floorData.id);
    },
    routeTo(path) {
      this.$router.push({
        path: path + "?tab=3",
    ...
    callChildFunction(id) {
      ...
      if (this.tab == 2) {
        this.$refs.childComponentRef.getElectricityFee(
          id,
          this.filter.selectedMonth,
          this.filter.selectedYear
        );
