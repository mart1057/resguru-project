                    ...
                    <div class="flex justify-between">
                        ...
                        <div v-if="tab == 1">
                            <input class="h-[28px] w-[120px] rounded-[12px] border flex justify-start" id="upload" hidden
                                type="file" @change="importWater()" ref="importExcel" 
                            ...
                            <label for="upload">
                                <div
                                    ...
                                    <div class="text-white font-bold ml-[8px]   flex justify-center items-center">นำเข้ามิเตอร์น้ำผ่าน
                                        Excel
                                    </div>
                                </div>
                            </label> 
                            ...
                            <label>
                                <div
                                    ...
                                    <div class="text-white font-bold ml-[8px]   flex justify-center items-center"><a href="https://api.resguru.app/uploads/meter_Template_a0c087bcd6.xlsx" class="text-white " target="_blank" download> Download
                                        Excel Template </a>
                                    </div>
                                </div>
                            </label>
                        ...
                        <div v-else-if="tab == 2">
                            <input class="h-[28px] w-[120px] rounded-[12px] border flex justify-start" id="upload" hidden
                                type="file" @change="importElectrict()" ref="importExcel" 
                                accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" />
                            <label for="upload">
                                <div
                                    class="h-[36px] pl-[8px] pr-[8px] bg-[#39B974] flex cursor-pointer  justify-center rounded-[12px] mt-[12px]">
                                    ...
                                    <div class="text-white font-bold ml-[8px]   flex justify-center items-center">  นำเข้ามิเตอร์ไฟฟ้าผ่าน
                                        Excel
                                    </div>
                                </div>
                            </label> 
        ...
        importElectrict(){
            this.importExcel = this.$refs.importExcel.files[0]
                    if(this.importExcel.length != 0){
                                ...
                                formData.append("file", this.fileBanner);
                                formData.append("building", String(this.$store.state.building));
                                axios.put("https://api.resguru.app/api/importElectric", formData, {
                                    headers: {
                                    "Content-Type": "multipart/form-data",
                                    },
                                })                
