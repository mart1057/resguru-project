            ...
            <div class="w-[40%]">
                ...
                <div class="flex mt-[4px] w-[100%]">
                    <div class="mt-[8px] w-[100%] ">
                        <div class="flex items-center justify-between border h-[28px] rounded-[8px] pl-[12px] pr-[12px]">
                            <div class="flex justify-center items-center">
                                <div><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <mask id="mask0_2861_23329" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0"
                            ...
                            <div class="flex justify-center items-center">
                                <div>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <mask id="mask0_2861_23339" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0"
                                            y="0" width="24" height="24">
                                            <rect width="24" height="24" fill="#D9D9D9" />
                                        </mask>
