...
export default {
    ...
    data() {
        return {
            ...
            data1: [0], // Initialize with 0 for income
            data2: [0, 0, 0, 0], // Initialize with zeros for all expense categories
                ...
                donut: {
                    labels: {
                        ...
                        total: {
                            ...
                            fontFamily: "Prompt",
                            formatter: () => {
                                return this.formatNumber(this.data1[0] || 0);
                            }
                        },
                    },
                },
                        ...
                        donut: {
                            labels: {
                                ...
                                total: {
                                    ...
                                    fontFamily: "Prompt",
                                    formatter: () => {
                                        const total = this.data2.reduce((sum, value) => sum + (value || 0), 0);
