      ...
      <div class="flex flex-col justify-between w-[100%] h-[100vh!important]">
        <div class="pl-[50px] pt-[30px]">
          <div class="text-[white] flex mt-[16px] cursor-pointer">
            ...
            <div class="flex justify-center items-center" @click="routeTo()">
              ย้อนกลับ
            </div>
          </div>
        </div>
    ...
    <div class="w-[60%] pt-[10px]">
      <div class="flex flex-col justify-around w-[100%] h-[100%]">
        <div>
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <feBlend
                        mode="normal"
                        in="SourceGraphic"
                        in2="effect1_dropShadow_902_20136"
                        result="shape"
                      />
                    </filter>
                  </defs>
          ...
          <div
            class="flex justify-center items-center w-[100%] pl-[50px] pr-[50px]"
          >
        ...
        <div class="pl-[50px] pr-[50px] flex justify-end">
          <button
            ...
            class="h-[36px] bg-[#003765] text-white pl-[24px] pr-[24px] text-center rounded-[12px]"
          >
            สร้าง
          </button>
        </div>
  ...
  methods: {
    ...
    createBuilding() {
      ...
      if (
        ...
        this.buildingEmail != "" &&
        this.buildingTax != "" &&
        this.buildingDueDate != ""
      ) {
        // console.log("test v model", this.buildingName)
        axios
          .post("https://api.resguru.app/api" + "/buildings", {
            data: {
