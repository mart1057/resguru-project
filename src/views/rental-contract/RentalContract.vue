  ...
  <div class="p-[20px] pt-[20px]">
    ...
    >
      ...
      <div class="flex items-center mb-[8px] mt-[14px] table-container">
        ...
        >
          <div
            class="cursor-pointer mr-[8px] whitespace-nowrap"
            :class="tab_floor == i ? 'font-bold text-[16px]' : 'text-[#8396A6]'"
            @click="
              (tab_floor = i),
    ...
    <div class="mt-[24px]">
      <div class="text-[24px] font-bold">
        ชั้น {{ name_floor }} ({{ contract.length }})
      </div>
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[100%] gap-4 mt-[14px]"
      >
        <!-- //////////////////////////// Loop Room Contract /////////////////////// -->
        <div
          class="bg-[white] rounded-[16px] flex justify-between p-[14px] h-[160px] cursor-pointer"
          v-for="data in contract"
        >
          <div class="flex flex-col justify-between">
            <div class="ml-[14px]">
              <div class="text-[24px] font-bold text-[#141629]">
            ...
            <div class="ml-[14px]">
              <div class="flex">
                <div
                  class="h-[32px] pr-[8px] pl-[8px] cursor-pointer rounded-[12px]"
                  :class="
                  ...
                  @click="
                    data.roomStatus == 'Checked In'
                      ? (getDetailRentalContract(data.user_sign_contract.id),
                        (data_mock = data))
                ...
                >
                  <div class="flex items-center h-[100%]">
                    ...
                    <div
                      class="text-white font-bold ml-[4px] flex justify-center items-center"
                    >
                      {{
                        data.roomStatus == "Checked In"
                          ? "ดูสัญญาเช่า"
          ...
          <div class="flex flex-col justify-between">
            <div class="flex">
              ...
              <div
                :class="
                  data.roomStatus == 'Checked In'
                    ? 'text-[#0B9A3C] bg-[#CFFBDA]'
                    : 'text-[#003765] bg-[#F0F8FF]'
                "
            ...
            <div class="flex justify-end">
              <div
                @click="
                  data.roomStatus == 'Checked In'
                    ? PDFPrintRental(data, true, data.user_sign_contract.id)
                    : ''
                "
              >
                <svg
                ...
                >
                  ...
                  <g mask="url(#mask0_1318_22597)">
                    <path
                      ...
                      :fill="
                        data.user_sign_contract?.contractStatus == 'reserved'
                          ? '#B9CCDC'
                          : data.user_sign_contract
                          ? '#003765'
                          : '#B9CCDC'
            ...
            <div class="w-[100%] flex mt-[14px]">
              ...
              <div class="grid grid-cols-6 text-custom w-[70%]">
                <div class="col-span-3">
                  <div>
                    <span class="text-[red] mr-[2px]">*</span>Email
                    <span class="text-[#5C6B79]"
                      >สำหรับล็อกอินเข้าใช้แอปพลิเคชัน</span
                    >
                  </div>
                  <input
                    type="email"
            ...
            <div class="w-[100%] flex mt-[16px]">
              ...
              <div class="grid grid-cols-8 text-custom w-[70%]">
                ...
                <div class="col-span-4 mt-[16px]">
                  ...
                  <select
                    placeholder="Select"
                    v-model="room_detail_create.type_room"
                    disabled
                    class="h-[36px] w-[100%] mt-[6px] rounded-[12px] pl-[8px] pr-[8px] bg-[#F3F7FA]"
                  >
                    <option
                      v-for="type_room in room_type"
                      :value="type_room.id"
                    >
      ...
      <div>
        <div class="flex justify-between pl-[20px] pr-[20px]">
          <div
            class="text-custom flex justify-center items-center text-[18px] font-bold"
          >
            รายละเอียดสัญญาเช่า ห้อง {{ room_detail.number_room }}
          </div>
        ...
        <div class="pl-[20px] pr-[20px] mt-[24px]">
          ...
          <div class="mt-[24px]">
            <div class="w-[100%] flex">
              <div class="w-[30%] text-custom flex items-start text-[#5C6B79]">
                ข้อมูลหลัก
              </div>
              <dvi class="w-[70%]">
                <div class="grid grid-cols-8 text-custom">
                  ...
                  <div class="ml-[8px]">
                    ...
                    <div class="mt-[12px]">
                      {{ room_detail.nick_name ? room_detail.nick_name : "-" }}
                    </div>
                  </div>
                </div>
              </dvi>
            ...
            <div class="w-[100%] flex mt-[14px]">
              ...
              <div class="grid grid-cols-8 text-custom w-[70%]">
                <div class="col-span-4 mt-[14px]">
                  ...
                  <div class="mt-[12px]">
                    {{ room_detail.phone ? room_detail.phone : "-" }}
                  </div>
                </div>
            ...
            <div class="w-[100%] flex mt-[14px]">
              ...
              <div class="grid grid-cols-6 text-custom w-[70%]">
                <div class="col-span-2 mt-[14px]">
                  ...
                  <div class="mt-[12px]">
                    {{ room_detail.address ? room_detail.address : "-" }}
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="grid grid-cols-8 text-custom w-[70%]">
                ...
                <div class="col-span-4 ml-[8px] mt-[14px]">
                  ...
                  <div class="mt-[12px]" v-if="room_detail.contract_duration">
                    {{ room_detail.contract_duration }} เดือน
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    getRentalContract(code) {
      ...
      fetch(
        "https://api.resguru.app/api/getRoomContract?buildingid=" +
      ...
      fetch(
        ...
        .then((resp) => {
          ...
          this.room_detail.name =
            resp.data.attributes.users_permissions_user.data?.attributes.firstName;
          this.room_detail.last_name =
            resp.data.attributes.users_permissions_user.data?.attributes.lastName;
          this.room_detail.nick_name =
            resp.data.attributes.users_permissions_user.data?.attributes.nickName;
          this.room_detail.phone =
            resp.data.attributes.users_permissions_user.data?.attributes.phone;
          this.room_detail.id_card =
            resp.data.attributes.users_permissions_user.data?.attributes.idCard;
