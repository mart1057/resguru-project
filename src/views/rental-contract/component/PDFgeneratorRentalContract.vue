    ...
    <div hidden>
        ...
        formatDate(detail.user_sign_contract?.checkInDate) }}
                ...
                <div>
                    ...
                    <div class="ml-[80px]">(๑) ค่าไฟฟ้ายูนิตละ {{ $store.state.buildingInfo[0]?.attributes?.electricUnitPrice }} บาท</div>
                    <div class="ml-[80px]">(๒) ค่าน้ําประปาลูกบาศก์เมตรละ {{ $store.state.buildingInfo[0]?.attributes?.waterUnitPrice }} บาท</div>
                ...
                <div>
                    <span class="ml-[42px]">ข้อ ๘</span> ผู้เช่าต้องดูแลห้องพักอาศัยและทรัพย์สินต่างๆ
                ...
                <div>
                    <span class="ml-[42px]">ข้อ ๙</span> ผู้เช่าต้องเป็นผู้รับผิดชอบในบรรดาความสูญหาย เสียหาย
                    หรือบุบสลายอย่างใดๆ อันเกิดแก่ห้องพักอาศัยและทรัพย์สินต่างๆ ในห้องพักดังกล่าว
                </div>
                <div>
                    <span class="ml-[42px]">ข้อ ๑๐</span> ผู้เช่าต้องยอมให้ผู้ให้เช่า
                    หรือตัวแทนของผู้ให้เช่าเข้าตรวจดูห้องพักอาศัยได้เป็นครั้งคราวในระยะเวลาอันสมควร
                </div>
                <div>
                    <span class="ml-[42px]">ข้อ ๑๑</span> ผู้เช่าต้องไม่ทําการดัดแปลง ต่อเติม
                ...
                <div>
                    <span class="ml-[42px]">ข้อ ๑๒</span>
                ...
                <div>
                    ...
                    หากผู้เช่าละเมิดแล้วผู้ให้เช่าย่อมให้สิทธิตามข้อ ๑๖ และข้อ ๑๗ แห่งสัญญานี้ได้
                </div>
                <div>
                    <span class="ml-[42px]">ข้อ ๑๔</span> ผู้ให้เช่า ไม่ต้องรับผิดชอบในความสูญหายหรือความเสียหายอย่างใดๆ
                    อันเกิดขึ้น
                    แก่รถยนต์รวมทั้งทรัพย์สินต่างๆ ในรถยนต์ของผู้เช่า ซึ่งได้นํามาจอดไว้ในที่จอดรถยนต์ที่ผู้ให้เช่าจัดไว้ให้
                </div>
                <div>
                    <span class="ml-[42px]">ข้อ ๑๕</span>
                ...
                <div>
                    <span class="ml-[42px]">ข้อ ๑๖</span> หากผู้เช่าประพฤติผิดสัญญาข้อหนึ่งข้อใด หรือหลายข้อก็ดี
                ...
                <div>
                    <span class="ml-[42px]">ข้อ ๑๗</span> ในกรณีที่สัญญาเช่าระงับสิ้นลง ไม่ว่าด้วยเหตุใดๆ ก็ตาม
                ...
                <div>
                    <span class="ml-[42px]">ข้อ ๑๘</span> ในวันทําสัญญานี้
