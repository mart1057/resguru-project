  ...
  <div>
    <div class="grid grid-cols-7 w-[100%] gap-4 mt-[14px]">
      ...
      >
        ...
        <img
          class="w-[78px] h-[78px] rounded-[22px]"
          v-if="data.imageProfile"
          :src="'https://api.resguru.app' + data.imageProfile?.url"
          @click="getDetailRentalContract()"
        />
        <div @click="getDetailRentalContract()" class="text-[18px]">
        ...
        <div class="flex" @click="getDetailRentalContract()">
          <div class="grid grid-cols-1 gap-0">
            <div class="grid grid-cols-2 gap-0">
              ...
              <div
                class="flex justify-center items-center ml-[4px] text-[12px]"
              >
                {{ data.phone }}
              </div>
            </div>
      ...
      <div
        class="h-[212px] w-[11.25rem] border rounded-[12px] flex flex-col justify-center items-center p-[14px] cursor-pointer"
        v-if="user.length == 0"
        ...
        <div class="pl-[20px] pr-[20px] mt-[24px]">
          ...
          <div class="mt-[24px]">
            <div class="w-[100%] col-auto">
              ...
              <dvi class="w-[70%]">
                <div
                  class="grid grid-cols-2 text-custom"
                  v-if="is_edit == false"
                >
                  <div class="flex">
                    <vs-radio
                ...
                <div
                  class="grid grid-cols-4 text-custom mt-[14px]"
                ...
                <div v-else>
                  ...
                  <div class="mt-[10px]">
                    <div class="font-bold">
                      <span class="text-[red] mr-[2px]">*</span>เพศ
                    </div>
                    <div class="flex">
                      <div
                          ...
                          >
                            ...
                            <g mask="url(#mask0_902_17246)">
                              <path
                                ...
                                :fill="
                                  room_detail.sex == false ? 'white' : '#CC00FF'
                                "
                              />
                            </g>
                          </svg>
                ...
                <div
                  class="grid grid-flow-row-dense grid-cols-6 text-custom mt-[14px]"
                >
            ...
            <div
              class="w-[100%] grid grid-flow-row-dense grid-cols-6 mt-[14px]"
            >
            ...
            >
              <div class="col-span-4">
                <div class="text-custom">
                  <span class="text-[red] mr-[2px]">*</span>ที่อยู่
                </div>
                <input
                  type="input"
                  class="h-[36px] w-[100%] rounded-[12px] bg-[#F3F7FA]"
              ...
              <div class="col-span-2 mt-[6px] ml-[8px]">
                ...
                <div
                  class="flex mt-[4px]"
                  v-if="room_detail.image_card_name == ''"
                >
                  <input
            ...
            <div class="w-[100%] flex mt-[14px]">
              <div class="w-[30%] text-custom flex items-start">
                ข้อมูลเพิ่มเติม
              </div>
            </div>
            <div class="mt-[14px]">
                ...
                <div class="grid grid-cols-8 text-custom w-[100%]">
                  <div class="col-span-2">
                    ...
                    >
                      ...
                      <option label="รถยนต์" value="Car">รถยนต์</option>
            ...
            <div
              class="w-[100%] mt-[14px] flex"
              v-if="room_detail.vehicles.length != 2"
            >
              <div class="w-[100%]">
                <div class="grid grid-cols-8 text-custom w-[100%]">
        ...
        <div class="pl-[20px] pr-[20px] mt-[24px]">
          ...
          <div v-for="data in roomFloor" class="text-custom">
            <div v-for="floor in data" class="mt-[14px] mb-[14px]">
              <div class="text-[#141629] font-bold">
                ชั้น {{ floor.floorName }}
              </div>
              <div class="grid grid-cols-8 w-[100%] gap-2 mt-[14px]">
                <div v-for="room in floor.attributes">
                  <div
                    class="h-[32px] bg-[#DEEAF5] rounded-[12px] flex items-center justify-between pl-[8px] pr-[8px]"
                    @click="
                    ...
                    :class="
                      room.status
                        ...
                        : 'bg-[#DEEAF5] text-[#003765] cursor-pointer'
                    "
                  >
    ...
    >
      <div>
        ...
        <div class="pl-[20px] pr-[20px] mt-[24px]">
          ...
          <div class="text-[#8396A6] text-custom mt-[24px]">
            คุณต้องการทำสัญญาหรือไม่ ?
          </div>
          <div
            class="grid grid-cols-2 gap-1 content-center mt-[44px] mb-[24px]"
          >
            <div
            ...
            >
              <div
                class="w-[350px] h-[250px] rounded-[12px] flex flex-col justify-between items-center p-[24px]"
                :class="
                  tab == 1
              ...
              >
                ...
                <div
                  class="text-custom flex justify-center items-center text-center mt-[8px]"
                >
