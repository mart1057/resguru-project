                ...
                <div class="pl-[20px] pr-[20px] mt-[24px]">
                    ...
                    <div class="grid grid-cols-2 gap-1 content-center mt-[44px] mb-[24px]">
                        <div class="flex justify-center items-center cursor-pointer" @click="tab = 1">
                            <div
                                class="w-[350px] h-[250px]   rounded-[12px] flex flex-col justify-between items-center p-[24px] " :class="tab == 1?'bg-[#003765] text-white':'bg-[#F3F7FA] text-[#003765]'">
                        ...
                        <div class="flex justify-center items-center cursor-pointer" @click="tab = 2">
                            <div
                            class="w-[350px] h-[250px]   rounded-[12px] flex flex-col justify-between items-center p-[24px] " :class="tab == 2?'bg-[#003765] text-white':'bg-[#F3F7FA] text-[#003765]'">
