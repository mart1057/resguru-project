<template>
  <div
    class="h-[100%] bg-[white] rounded-[12px] pt-[28px] pl-[28px] pr-[28px] pb-[28px] mt-[14px] mr-[24px] ml-[24px]"
    id="room-detail"
  >
    <div class="">
    ...
    <div class="flex mt-[14px]">
      <div
        class="text-[20px] font-bold text-[#141629] flex items-center justify-center"
      >
        ห้อง {{ $route.query.number_room }}
      </div>
      <div
        :class="
      ...
      <div class="bg-[#F3F7FA] rounded-[12px]">
        <div class="flex justify-start items-center">
          ...
          <div
            ...
            v-if="$route.query.status == 'Checked In'"
            :class="
              tab == 4
                ? 'bg-[#003765] pl-[9px] pr-[9px] pt-[8px] pb-[8px] rounded-[12px] text-[white]'
                : ' text-[#003765] pl-[9px] pr-[9px] pt-[8px] pb-[8px] flex justify-center items-center'
    ...
    <div v-if="tab == 1">
      ...
      <div class="grid grid-cols-6 gap-4 pb-3">
        <!-- CardMember component should take up 2 out of 6 columns -->
        <div class="col-span-2">
          <CardMember
            :id_user="$route.query.id_user"
            :id_room="$route.query.id_room"
            :status="$route.query.status"
            :id_contract="$route.query.id_contract"
          />
        </div>

        <!-- Contract component should take up 4 out of 6 columns -->
