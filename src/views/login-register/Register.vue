                ...
                <div
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-3 w-[100%] gap-4">
                            <div>
                                <div class="mt-[8px]">
                                    <vs-select placeholder="วัน" v-model="value" color="#003765">
                                        <vs-option v-for="day in days" label="Vuesax" :value="day">
                                            {{ day }}
                                        </vs-option>
                                    </vs-select>
                                </div>
                            ...
                            <div>
                                <div class="mt-[8px]">
                                    <vs-select placeholder="เดือน" v-model="value" color="#003765">
                                        <vs-option v-for="mouth in mouths"  :value="mouth">
                                            {{ mouth }}
                                        </vs-option>
                                    </vs-select>
                                </div>
                            ...
                            <div>
                                <div class="mt-[8px]">
                                    <vs-select placeholder="ปี" v-model="value" color="#003765">
                                        <vs-option v-for="year in years"  :value="year">
                                            {{ year }}
                                        </vs-option>
                                    </vs-select>
                                </div>
                        ...
                        <div class="mt-[10px]">
                            ...
                            <div class="">
                                <input type="password" placeholder="08x-xxx-xxxx"
                                    class="h-[36px] w-[100%] rounded-[12px] bg-[#F3F7FA]" />
                            </div>
                        </div>
                        <div class="mt-[10px]">
